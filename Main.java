...
class OnlineTestBegin extends JFrame implements ActionListener
{
    ...
    void set()
    {
        ...
        if(current==0)
        {
            l.setText("Que1:  Which of these components are used in a Java program for compilation, debugging, and execution?");
            jb[0].setText("JDK");jb[1].setText("JVM");jb[2].setText("JRE");jb[3].setText("JIT");
        }
        if(current==1)
        {
            l.setText("Que2: . Which of these literals can be contained in a float data type variable?");
            jb[0].setText("-3.4e+050");jb[1].setText("+1.7e+308");jb[2].setText(" -3.4e+038");jb[3].setText("-1.7e+308");
        }
        if(current==2)
        {
